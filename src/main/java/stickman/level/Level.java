...
public interface Level {
    ...
    /**
     * Stops level and try move to next level
     * if wins the last level show winning message
     */
    void win();

    /**
     * Stops level when hero's life is 0
     * shows GameOver message
     */
    void lose();

    /**
     * to provide the active or not info to game engine to decide updating time
     * @return Whether the level is active
     */
    boolean isActive();

    /**
     * get target time of the level
     * @return target time
     */
    int getTargetTime();
